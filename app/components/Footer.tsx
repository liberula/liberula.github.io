  ...
  return (
    <div className='flex flex-col bg-liberula-yellow'>
      <div className=' grid grid-cols-1 tablet:grid-cols-2 laptop:grid-cols-3 items-center justify-items-center align-middle gap-10 pt-10 '>
        ...
        <FooterButton icon_path={'/images/contact.svg'} center_text={'Have a project in mind?'} bottom_text={'CONTACT US'}  link={'/contact'} />
      ...
      <div className='grid grid-cols-2 justify-center align-center items-center pt-10'>
          <span className='align-center text-center'>© LIBERULA 2024</span>
          <Link className='align-center text-center' href={'/'}>TERMS OF SERVICE</Link>
          <Link className='align-center text-center' href={'/'}>BACK TO TOP</Link>
          <Link className='align-center text-center' href={'/'}>PRIVACY POLICY</Link>
      </div>
    </div>
